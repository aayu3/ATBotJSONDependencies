...
for (var i = 0; i < supporters.length; i ++) {
    ...
    allSupportersHTML("#supporters").append("<li><img src=\"supporter_images/" + supporters[i].Preview  + ".png\" alt=\"" + supporters[i].Name +"\"/><a  target = \"_blank\" href=\"supporters_html/" + numString + ".html\">" + supporters[i].Name + "</a></li>\n");
